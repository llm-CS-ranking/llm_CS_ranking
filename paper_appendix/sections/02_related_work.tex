...
Recent systems move toward full stock selection and portfolio construction: MarketSenseAI and its agentic extension use GPT-4 for holistic selection \citep{fatouros2024marketsenseai,fatouros2025marketsenseai2}; TradExpert combines expert LLMs for prediction and ranking \citep{ding2025tradexpert}; FinMem, TradingAgents, FinCon, and MASS introduce memory, debate, manager--analyst, or scaling-simulation agent designs for trading and portfolio management \citep{yu2025finmem,xiao2024tradingagents,yu2024fincon,guo2025mass}; prompt-guided GuruAgents encode investor personas into tool-using LLM agents \citep{kim2025guruagents}; and \citet{lee2025llmbl} integrate LLM views into Black--Litterman and report model-specific ``investment styles.''
Complementary threads study LLM-enhanced momentum \citep{anic2025chatgpt}, region-specific prediction \citep{tan2024llmchina}, exploratory portfolio selection \citep{xie2024wallstreetneophyte,romanko2023chatgptportfolio}, and decision-focused optimization layers \citep{hwang2025dinn,kim2025dsl}.
...
LLMs have also been used to generate predictive factors, mine decay-resistant alphas, and automate quant factor--model R\&D \citep{cheng2024chatgptfactor,tang2025alphaagent,li2025rdagent}, coordinate financial decisions via multi-agent systems \citep{lyu2025alphaagents,cheng2024aapm,yang2024finrobot}, and query financial databases through constrained function-calling interfaces \citep{kim2025finaidata}; see \citet{nie2024surveylargelanguagemodels} for a survey.
