...
\input{tables/conservative_longshort.tex}
...
\input{tables/conservative_ensemble_robustness.tex}
...
\input{tables/conservative_ff6.tex}
...
\input{tables/conservative_input_ablation.tex}

\begin{figure*}[!t]
  \centering
  \includegraphics[width=0.94\textwidth]{figures/fig4_ls_cumulative_returns.pdf}
  \caption{Cumulative Q1$-$Q5 wealth by model and prompt objective; the dashed line marks zero spread wealth.}
  \Description{Line plots of cumulative long-short wealth over time for each model and prompt objective, showing persistent gains for strong models and losses for weak models relative to a zero-spread baseline.}
...
Figure~\ref{fig:ls-cumret-main} shows the same pattern in cumulative wealth: Gemini 2.5 Pro/Flash and GPT-4.1 accumulate positive spreads, while GPT-4o and GPT-4o mini lose money.
